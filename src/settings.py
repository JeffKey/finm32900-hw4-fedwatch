...
## Pull window for Databento futures data (trailing ~6 months, as date strings)
defaults["START_DATE"] = (datetime.today() - timedelta(days=180)).strftime("%Y-%m-%d")
defaults["END_DATE"] = datetime.today().strftime("%Y-%m-%d")
